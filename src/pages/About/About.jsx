...
const testimonials = [
    {
        ...
        avatar:
            'https://thumbs.dreamstime.com/b/beautiful-young-woman-avatar-character-beautiful-young-woman-avatar-character-vector-illustration-design-178340359.jpg',
    }
];
    ...
    return (
        <Flex
            ...
            <Flex
                ...
                <chakra.p fontFamily={'Roboto'} color={'blue'} fontWeight={'bold'} fontSize={14}>
                    {name}
                    <chakra.span
                        fontFamily={'Roboto'}
                        fontWeight={'medium'}
